...
#   - - - http://www.365admin.com.au/2017/06/hybrid-management-part-01-creating.html        #
#                                                                                           #
#############################################################################################

$CSVLocation = "C:\Scripts\LocalUserMailboxes.csv"

### Step 1 - User Creation

Import-CSV $CSVLocation | ForEach-Object {
New-EXLMailbox -Name $_.Name -FirstName $_.FirstName -Initials $_.Initials -Lastname $_.LastName -UserPrincipalName $_.UPN -OrganizationalUnit $_.OU -Password (ConvertTo-SecureString $_.password -AsPlainText -Force) -ResetPasswordOnNextLogon $true
...
Write-Host "Local User Mailboxes created and synched to Office 365"