...
#   - - - http://www.365admin.com.au/2017/06/hybrid-management-part-02-creating.html        #
#                                                                                           #
#############################################################################################

$CSVLocation = "C:\Scripts\LocalSharedMailboxes.csv"

### Step 1 - Shared Mailbox Creation

Import-CSV $CSVLocation | ForEach-Object {
New-EXLMailbox -Shared -Name $_.Name -FirstName $_.FirstName -Initials $_.Initials -Lastname $_.LastName -UserPrincipalName $_.UPN -OrganizationalUnit $_.OU 
...
Write-Host "Local Shared Mailboxes created and synched to Office 365"