...
$CSVLocation = "C:\Scripts\RemoteEquipmentMailboxes.csv"

### Step 1 - User Creation

Import-CSV $CSVLocation | ForEach-Object {
New-EXLRemoteMailbox -Equipment -Name $_.Name -FirstName $_.FirstName -Initials $_.Initials -Lastname $_.LastName -UserPrincipalName $_.UPN -OnPremisesOrganizationalUnit $_.OU
...
Write-Host "Remote Equipment Mailboxes created and synched to Office 365."